...
const dontDoThis = ((n1 + n2 + n3 + n4) == 50) && 
  ...
  //check all numbers are divi
  const isDividedByTwo = (n1 % 5 && n2 % 5 && n3 % 5 && n4 % 5) === 0
  console.log(`That is ${isDividedByTwo} that all numbers can be divided by 5.`);

  //check if first number is larger than the last
  const firstLarger = (n1 > n4) 
  console.log(`That is ${firstLarger} that first number is larger than last`);
...
// Find the remainder of dividing the result by the fourth number.
  ...
  const isValidtoo = isSum50 && isTwoOdd && isLess25 && isUnique;
  console.log(`this is the other way for isOver25 with same result as ${isValidtoo}`)
